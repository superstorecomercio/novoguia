-- Migration: Corrigir ambiguidade de campanha_id na função processar_campanhas_vencendo
-- Data: 2025-11-27
-- Descrição: Corrige referência ambígua à coluna campanha_id na função
...
-- Recriar função auxiliar corrigida
...
BEGIN
  ...
  FOR v_registro IN
    SELECT * FROM adicionar_emails_campanhas_vencendo()
  LOOP
