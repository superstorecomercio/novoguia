-- ============================================
-- MIGRATION 026: Reverter filtro por estado
-- ============================================
-- Restaura a função criar_orcamento_e_notificar para o comportamento original
-- que filtra por cidade quando encontrada, ou por estado quando não encontrada
-- ============================================

-- Garantir que a função buscar_hotsites_ativos_por_cidade existe
...
-- Restaurar função original com comportamento anterior
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '================================================';
  RAISE NOTICE '✅ MIGRATION 026 CONCLUÍDA - FUNÇÃO RESTAURADA!';
  RAISE NOTICE '================================================';
  RAISE NOTICE 'Comportamento restaurado:';
  RAISE NOTICE '  - Filtra por cidade se encontrada no banco';
  RAISE NOTICE '  - Filtra por estado se cidade não for encontrada';
  RAISE NOTICE '================================================';
END $$;
