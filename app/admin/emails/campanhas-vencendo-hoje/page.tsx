...
export default function EmailsCampanhasVencendoHojePage() {
  ...
  const fetchEmails = async () => {
    try {
      ...
      let query = supabase
        ...
        `)
        .eq('tipo_email', 'campanha_vencendo_hoje')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Fila de Emails - Campanhas Vencendo Hoje</h1>
          <p className="text-gray-500 mt-1">Emails enviados para campanhas que vencem hoje</p>
        </div>
      </div>
